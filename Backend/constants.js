...
export const MODEL_REGISTRY = [
    ...
    },
    {
        ...
        capabilities: [ModelTypes.text, ModelTypes.structuredOutputs, ModelTypes.websearch, ModelTypes.maps],
        maxContext:   1048576,
        quality:      AiQuality.Base,
    },
    {
    ...
    },
    {
        ...
        provider:     AiProviders.gemini,
        capabilities: [ModelTypes.text, ModelTypes.structuredOutputs, ModelTypes.websearch, ModelTypes.maps, ModelTypes.reasoning],
        maxContext:   1048576,
    ...
    },
    {
        ...
        provider:     AiProviders.anthropic,
        capabilities: [ModelTypes.text, ModelTypes.structuredOutputs, ModelTypes.code, ModelTypes.reasoning],
        maxContext:   200000,
        quality:      AiQuality.Pro,
    },
    {
        ...
        capabilities: [ModelTypes.text, ModelTypes.deepResearch, ModelTypes.websearch],
        maxContext:   127072,
        quality:      AiQuality.Advanced,
    },
    // {
