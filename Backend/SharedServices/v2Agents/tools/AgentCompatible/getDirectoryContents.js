...
export const details = {
    ...
    guide:      "You need to provide a relative folder path. YOU MUST ensure that this doesn't start with /data/ - the root directory is /UserFiles/",  
    inputSchema:{
    "type": "object",
    "properties": {
        "relativeFolderPath": {
...
export async function run( 
    ...
    let call = await Shared.fileSystem.CRUD.scanFolderRecursively(decodedPath.trim());
