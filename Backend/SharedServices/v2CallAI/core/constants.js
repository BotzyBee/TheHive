...
export const MODEL_REGISTRY = [
  ...
  },
  {
    ...
    provider: AiProviders.openAI,
    capabilities: [ModelTypes.code, ModelTypes.structuredOutputs],
    maxContext: 400000,
    quality: AiQuality.Base,
    active: true,
    id: 'no-db-id',
  ...
  },
  {
    ...
    capabilities: [ModelTypes.deepResearch, ModelTypes.websearch],
    maxContext: 127072,
    quality: AiQuality.Base,
    active: true,
    id: 'no-db-id',
  ...
  },
  {
    ...
    provider: AiProviders.gemini,
    capabilities: [ModelTypes.image, ModelTypes.structuredOutputs],
    maxContext: 65536,
    quality: AiQuality.Advanced,
    active: true,
    id: 'no-db-id',
