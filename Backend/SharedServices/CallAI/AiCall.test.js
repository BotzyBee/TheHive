...
const makeMockDispatch = (overrides = {}) => ({
  [AiProviders.gemini]: vi
    .fn()
    .mockResolvedValue({ ok: true, value: 'gemini-response' }),
  [AiProviders.anthropic]: vi
    .fn()
    .mockResolvedValue({ ok: true, value: 'anthropic-response' }),
  [AiProviders.openAI]: vi
    .fn()
    .mockResolvedValue({ ok: true, value: 'openai-response' }),
  [AiProviders.perplexity]: vi
    .fn()
    .mockResolvedValue({ ok: true, value: 'perplexity-response' }),
  ...overrides,
});
