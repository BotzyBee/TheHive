 ...
 */
export async function callGemini(systemMessage, contentMessage, model, options = {}) {
        ...
        if (structuredOutput && useWeb) {
            ...
            const secondResponse = await ai.models.generateContent({
                ...
                config: {
                    ...
                    systemInstruction: "Analyse the input text and convert it to the output schema. Do not add new thoughts or new research."
                },
            });
